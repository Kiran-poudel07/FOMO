...
# ================================
# Print Loneliness Level Counts by Gender
# ================================
loneliness_gender_counts = df.groupby(['Gender', 'loneliness_level']).size().unstack().reindex(columns=['High Loneliness', 'Moderate Loneliness', 'Low Loneliness']).fillna(0)
print("\nLoneliness Level Counts by Gender:")
print(loneliness_gender_counts)

# ================================
# Print Loneliness Level Counts by Department
# ================================
loneliness_dept_counts = df.groupby(['Department', 'loneliness_level']).size().unstack().reindex(columns=['High Loneliness', 'Moderate Loneliness', 'Low Loneliness']).fillna(0)
print("\nLoneliness Level Counts by Department:")
print(loneliness_dept_counts)

# ================================
# Print Loneliness Level Counts by Year
# ================================
loneliness_year_counts = df.groupby(['Year', 'loneliness_level']).size().unstack().reindex(columns=['High Loneliness', 'Moderate Loneliness', 'Low Loneliness']).fillna(0)
print("\nLoneliness Level Counts by Academic Year:")
print(loneliness_year_counts)
...
for gender in df['Gender'].unique():
    ...
    plt.pie(dist, labels=dist.index, autopct='%1.1f%%', colors=['red', 'orange', 'skyblue'], startangle=140)
...
for dept in df['Department'].unique():
    ...
    plt.figure(figsize=(5,5))
    plt.pie(dist, labels=dist.index, autopct='%1.1f%%', colors=['red', 'orange', 'skyblue'], startangle=140)
    plt.title(f'Loneliness Distribution – {dept} Department')
    plt.tight_layout()
    plt.show()

# ================================
# Pie Charts by Academic Year
# ================================
